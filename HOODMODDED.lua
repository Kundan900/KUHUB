print("al Is a nigger")

game:GetService("StarterGui"):SetCore("SendNotification",{     

	Title = "CREDITS",     

	Text = "Gui By G_87#5392 Scripted By kun#0001",
...
Credits:Button("Gui By G_87#5392 Scripted By kun#0001",function()

	print ("KU WIN")

end)

Credits:Button("KuW",function()
