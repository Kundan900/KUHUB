print("al Is a nikger")

game:GetService("StarterGui"):SetCore("SendNotification",{     

Title = "CREDITS",     

Text = "Gui By G_87#5392 Scripted bY Ku",
...
Credits:Button("Gui By G_87#5392 Scripted By Ku",function()

print ("GA$ WIN")

end)

Credits:Button("ez",function()

print ("Join https://discord.gg/77MfmAjEdS")
